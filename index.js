...
// daftar TPS (sama seperti punyamu)
const daftarTPS = [
...
client.on('message', async (message) => {
  ...
  if (message.hasMedia) {
    ...
    try {
      ...
      // Struktur respons: { parent:{label,confidence,uncertain}, sub:{label,confidence}, top3_sub:[...] }
      ...
      // minta rekomendasi berdasarkan label sub (lebih spesifik)
      ...
      await message.reply('⚠️ Gagal memproses gambar. Pastikan server AI aktif dan bisa diakses.');
    } finally {
